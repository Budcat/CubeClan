...
class USersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create u_ser" do
    assert_difference('USer.count') do
      post u_sers_url, params: { u_ser: { email: @u_ser.email, id: @u_ser.id, name: @u_ser.name, password: @u_ser.password } }
    end
  ...
  test "should update u_ser" do
    patch u_ser_url(@u_ser), params: { u_ser: { email: @u_ser.email, id: @u_ser.id, name: @u_ser.name, password: @u_ser.password } }
